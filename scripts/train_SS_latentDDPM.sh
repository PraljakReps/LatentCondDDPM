...
# filepaths
export fig_output_path='.././output/SSlatentDDPM/mnist_samples_'
export output_model_path='.././output/SSlatentDDPM/model_pretrained_weights'
export output_csv_path='.././output/SSlatentDDPM/model_train_history.csv'
export tsne_path='.././output/SSlatentDDPM/tsne_plot_'
